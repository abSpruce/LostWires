...
<html>
    <head>
        ...
        <title>LostWires: New Reservation</title>
        <LINK REL=STYLESHEET
              HREF="lostwires.css"
              TYPE="text/css">
    </head>
    ...
    <body class="twoColFixLtHdr">
        ...
        <div id="container">
            <div id="header">
                <h1>Request Product Reservation</h1>
                <!-- end #header --></div>
            ...
            <TABLE align=center border=1>
               <TH align=center> SKU </TH><TH align=center> Description </TH><TH align=center> Qty On Hand </TH><TH align=center> Qty BackOrdered </TH><TH align=center> Qty On Reserve </TH><TH align=center> Status </TH><TH align=center> Serial </TH>
            <%
                        /*
                        ...
                        while (rs.next()) {
                           av.addElement("<a href=\"itemReserve.jsp?sku=" + rs.getInt("sku") + "\">&nbsp;" + rs.getInt("sku") + "&nbsp;</a>");
